...
const FuzzyText: React.FC<FuzzyTextProps> = ({
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      // Store cleanup on the element is generally a bad idea in React, 
      // but we use it here because we provide it in the useEffect return.
      // However, it's safer to just return the cleanup function directly.
      return cleanup;
    };
