...
const signUpSchema = z.object({
  name: z.string().min(2, "Hunter name must be at least 2 characters"),
      ...
      >
        <div className="glass-panel neon-border p-8 md:p-10 rounded-xl bg-card/80 backdrop-blur-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-sm">Create your account to begin the journey</p>
          </div>
              ...
              <div className="pt-6 space-y-5">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-foreground/90">Hunter Name</Label>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        {...register("name")}
                        className={`h-12 pl-10 bg-secondary/40 border-border/40 focus-visible:ring-primary ${errors.name ? "border-destructive/50" : ""}`}
                      />
                    </div>
                    {errors.name && (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`h-12 pl-10 bg-secondary/40 border-border/40 focus-visible:ring-primary ${errors.confirmPassword ? "border-destructive/50" : ""}`}
                      />
                    </div>
          ...
          <div className="mt-8 text-center text-sm text-muted-foreground">
            Already a hunter?{" "}
            <Link to="/sign-in" className="text-accent hover:text-accent/80 font-medium transition-colors">
              Sign in
            </Link>
          </div>
        </div>
